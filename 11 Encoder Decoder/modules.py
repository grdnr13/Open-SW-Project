            ...
            for i in range(preds.shape[0]):
                ...
                for j in range(temp.shape[0]):
                    for k in range(temp.shape[1]):
                        ...
                        predict = temp[j][k]
                        label = temp_l[j][k]
                        temp_rgb[j, k, 0] = cls_invert[predict][0]
                        temp_rgb[j, k, 1] = cls_invert[predict][1]
                        temp_rgb[j, k, 2] = cls_invert[predict][2]
                        temp_label[j, k, 0] = cls_invert[label][0]
                        temp_label[j, k, 1] = cls_invert[label][1]
                        temp_label[j, k, 2] = cls_invert[label][2]
