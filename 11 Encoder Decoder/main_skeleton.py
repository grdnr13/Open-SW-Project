...
data_dir = "/content/drive/MyDrive/osp15/VOC2012"
resize_size = 256
...
model.load_state_dict(torch.load('/content/drive/MyDrive/Colab Notebooks/osp15/trained_model/resnet_encoder_unet.pth', map_location=device))
#model.load_state_dict(torch.load('/content/drive/MyDrive/Colab Notebooks/osp15/trained_model/UNet_trained_model.pth', map_location=device))
...
for epoch in range(epochs):
    ...
    if epoch % 4 == 0:
        ...
        #PATH = '/content/drive/MyDrive/Colab Notebooks/osp15/trained_model/UNet_trained_model.pth'
        PATH = '/content/drive/MyDrive/Colab Notebooks/osp15/trained_model/resnet_encoder_unet.pth'
